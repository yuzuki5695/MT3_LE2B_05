...
Matrix4x4 Inverse(const Matrix4x4& m) {
	...
	float det =
		matrix.m[0][0] * (matrix.m[1][1] * matrix.m[2][2] - matrix.m[2][1] * matrix.m[1][2]) -
		matrix.m[0][1] * (matrix.m[1][0] * matrix.m[2][2] - matrix.m[2][0] * matrix.m[1][2]) +
		matrix.m[0][2] * (matrix.m[1][0] * matrix.m[2][1] - matrix.m[2][0] * matrix.m[1][1]);
